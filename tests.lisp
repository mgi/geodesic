...
(test roots-test
  (let ((epsilon 1e-6))
    (multiple-value-bind (r1 r2 r3) (cubic-roots 1 -6 6 -2)
    ...
    (multiple-value-bind (r1 r2 r3) (cubic-roots 2 -4 -22 24)
      (is (about= r1 4 epsilon))
      (is (about= r2 -3 epsilon))
      (is (about= r3 1 epsilon)))
    (multiple-value-bind (r1 r2 r3) (cubic-roots 1 6 12 8)
      (is (about= r1 -2 epsilon))
      (is (about= r2 -2 epsilon))
      (is (about= r3 -2 epsilon)))
    (multiple-value-bind (r1 r2 r3 r4) (quartic-roots 1 -4 0 5 2)
      (is (about= r1 (/ (+ 3 (sqrt 17)) 2) epsilon))
      (is (about= r2 (/ (+ 1 (sqrt 5)) 2) epsilon))
      (is (about= r3 (/ (- 3 (sqrt 17)) 2) epsilon))
      (is (about= r4 (/ (- 1 (sqrt 5)) 2) epsilon)))))
